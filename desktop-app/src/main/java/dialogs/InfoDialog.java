...
public class InfoDialog extends JDialog {
    ...
    public InfoDialog(String infoText) {
        ...
        Styler.styleInfoCard(contentPnl, infoPnl, menuPnl, okPnl, infoLbl, okLbl);

        infoLbl.setText("<html>" + infoText.replaceAll("\n", "<br/>") + "</html>");
...
// DO NOT EDIT OR ADD ANY CODE HERE!
    ...
    private void $$$setupUI$$$() {
        ...
        contentPnl.setLayout(new com.intellij.uiDesigner.core.GridLayoutManager(3, 1, new Insets(10, 20, 10, 20), -1, -1));
        menuPnl = new JPanel();
